...
new_bg = """/* 3D Perspective Grid Background */
.perspective-grid-bg {
    position: absolute;
...
css = re.sub(r'/\* 3D Perspective Grid Background \*/.*?/\* Timeline Section \*/', new_bg + '\n\n/* Timeline Section */', css, flags=re.DOTALL)

with open('styles.css', 'w', encoding='utf-8') as f:
    f.write(css)

print("Updated grid CSS.")
